      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="space-y-2">
              <Button type="button" variant="default" onClick={() => document.getElementById("avatar-upload")?.click()} disabled={isUploading}>
                Upload picture
              </Button>
        ...
        <div className="space-y-2">
          ...
          <Textarea id="bio" value={bio} onChange={(e) => setBio(e.target.value)} placeholder="Tell us a bit about yourself" className="resize-none" rows={3} />
