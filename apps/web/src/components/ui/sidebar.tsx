    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn("group/sidebar-wrapper flex min-h-full w-full has-[[data-variant=inset]]:bg-sidebar", className)}
          ref={ref}
          {...props}
        >
          {children}
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "duration-200 fixed inset-y-[var(--header-height)] z-10 hidden h-[calc(100%-var(--header-height))] w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
          side === "left"
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4)-64)] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
        className,
      )}
      {...props}
    />
...
const SidebarMenuItem = React.forwardRef<HTMLLIElement, React.ComponentProps<"li">>(({ className, ...props }, ref) => (
  <li
    ...
    className={cn("group/menu-item relative group-data-[state=collapsed]:flex group-data-[state=collapsed]:justify-center", className)}
    {...props}
  />
));
