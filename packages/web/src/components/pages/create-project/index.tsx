...
import {
	ProjectTemplateUI,
	ProjectTemplateAssignee,
	ProjectTemplatePriority,
...
const templates: ProjectTemplateUI[] = [
	{
		...
		features: [
			...
			},
			{
				...
				description:
					'Sprints are short, time-boxed periods when a team collaborates to complete a set amount of customer value. Use sprints to drive incremental delivery.'
			},
			{
				title: "Understand your team's velocity",
				description:
					'Improve predictability on planning and delivery with out-of-the-box reports, including the sprint report and velocity chart.'
			}
		],
		taskTypes: [
			{ name: 'Epic', icon: 'Epic' },
	...
	},
	{
		...
		name: 'Kanban',
		description:
			'Visualize and manage work in a continuous flow. Best for teams that want to manage work in a flexible way.',
		features: [
			{
		...
		assignee: { multiple: false },
		taskProperties: [{ name: 'Due Date', type: 'date' }],
...
export default function CreateProject() {
	...
	const setTaskPropertys = (taskProperties: TaskProperty[]) => {
				...
				<div className='lg:col-span-4 min-h-screen'>
					...
					<div className='space-y-4'>
						...
						<div className='space-y-8'>
							...
							<EditTaskProperties
								attributes={selectedTemplate.taskProperties}
								setAttributes={setTaskPropertys}
							/>
